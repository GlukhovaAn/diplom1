...
// Create new admin (only  admin can do this)
router.post("/create", async (req, res) => {
  try {
    ...
    if (requestingAdmin.email !== "admin@gmail.com") {
      return res
        .status(403)
        .json({ message: "Only super admin can create new admin accounts" });
    }
...
router.get("/list", async (req, res) => {
  try {
    ...
    if (requestingAdmin.email !== "admin@gmail.com") {
      return res
        .status(403)
        .json({ message: "Only super admin can view admin list" });
    }
...
router.delete("/:id", async (req, res) => {
  try {
    ...
    if (requestingAdmin.email !== "admin@gmail.com") {
      return res
        .status(403)
        .json({ message: "Only super admin can remove admin privileges" });
    }
    ...
    if (targetAdmin.email === "admin@gmail.com") {
      return res
        .status(403)
        .json({ message: "Cannot remove super admin privileges" });
    }
